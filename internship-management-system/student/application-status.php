        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Internship Application Status</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th scope="col">Advisor Approval</th>
...
INNER JOIN donemler ON staj_tarih.donem_id=donemler.id WHERE kullanicilar.id =:id");
                            ...
                            <tr>
                            <th><?= $record["ad_soyad"]; ?></th>
                            <td>
                                <?php
                                if ($record["mudur_onay"]==0){
                            ...
                            <td><?= $record["create_tarih"]; ?></td>
                            <td>
                                <a class="btn btn-info" href="<?php echo "pdf/index.php?id=".$_SESSION["kullanici"]["id"] ?>" >Download File</a>
                                <a class="btn btn-danger" href="<?php echo "../ajax/staj_kayit_sil.php?id=".$record["id"]?>" >Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
